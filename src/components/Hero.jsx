    ...
    <>
      ...
      >
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[605px]">
          {/* Data Info  */}
          <div className="felx flex-col justify-center py-14 md:py-0 xl:max-w-[500px] text-white order-2 md:order-1">
            <div className="space-y-5 text-center md:text-left">
              ...
              <motion.div
                ...
                className="flex items-center justify-center md:justify-start gap-4 !md:mt24 !mb-10"
              >
